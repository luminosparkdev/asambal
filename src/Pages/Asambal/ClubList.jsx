...
import { EyeIcon, CheckCircleIcon, PlusIcon } from "@heroicons/react/24/outline"
              ...
              {filteredClubs.map(club => (
                <tr key={club.id} className="transition-colors hover:bg-white/5">
                  ...
                  <td className="px-4 py-2 text-center">
                    <span
                      className={`px-2 py-1 text-xs font-medium rounded-full ${club.status === "ACTIVO"
                  ...
                  <td className="flex gap-2 px-4 py-2">
                    ...
                    <button
                      ...
                      className={`flex items-center gap-1 ml-auto px-3 py-1 text-sm text-white rounded w-32 ${club.status === "ACTIVO"
                          ? "flex justify-center items-center gap-1 ml-auto px-3 py-1 text-sm text-gray-200 bg-red-700/95 rounded-md hover:bg-red-500 hover:text-gray-100 hover:cursor-pointer transition-all"
                          : "flex justify-center items-center gap-1 ml-auto px-3 py-1 text-sm text-gray-200 bg-green-700/95 rounded-md hover:bg-green-500 hover:text-gray-100 hover:cursor-pointer transition-all"
                        }`}
                    >
                      {club.status === "ACTIVO"
