...
function PlayerDetailsClub() {
  ...
  const handleSave = async () => {
    ...
    try {
      await api.put(`/clubs/players/${id}`, form);
  ...
  const handleToggle = async () => {
    ...
    try {
      await api.patch(`/clubs/players/${id}/toggle`);
              ...
              <div key={name} className="flex flex-col gap-1">
                ...
                {editing ? (
                  <input
                    ...
                    className="px-3 py-2 text-gray-100 bg-gray-800/70 border border-white/10 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                ) : (
                  <div>
            ...
            {editing ? (
              <>
                ...
                <button
                  ...
                  className="flex-1 py-3 bg-gray-700 hover:bg-gray-600 text-gray-200 rounded-lg"
                >
                  Cancelar
                </button>
              </>
...
export default PlayerDetailsClub;