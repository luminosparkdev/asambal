        ...
        <div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
          ...
          <Link to="/" className="text-xl font-bold tracking-wide hover:text-blue-200 w-[50px]">
            <img
              src={logo}
              alt="logo asambal"
              className="h-20 w-auto object-contain drop-shadow-[0_0_6px_rgba(255,255,255,0.6)]"
            />
          </Link>
              ...
              {isAuthenticated && (
                <>
                    {isAuthenticated && !isLogin && (
                      <div className="flex items-center gap-4 justify-between h-16 px-4 sm:px-6 lg:px-8">
                        {/*Volver*/}
